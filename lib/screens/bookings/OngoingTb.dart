// ignore_for_file: use_build_context_synchronously, must_be_immutable, camel_case_types, prefer_typing_uninitialized_variables, non_constant_identifier_names, file_names, unused_local_variable
...
import 'package:ridobiko/screens/bookings/widgets/payRemaining.dart';
...
class OngoingTb extends ConsumerStatefulWidget {
  List<BookingData> trips;
  FutureCallback getData;
  bool dataAvailable;
  OngoingTb(this.dataAvailable, this.trips, this.getData, {super.key});
...
class ongoing extends ConsumerState<OngoingTb> {
  var _view = false;
  var _popup;
  ...
  var _selectedEndTime = DateTime.now().add(const Duration(days: 1));
  ...
  void initState() {
    ...
    ref.read(gstProvider.notifier).fetch();
    super.initState();
  }
  ...
  Future<void> _handlePaymentSuccess(PaymentSuccessResponse response) async {
    ...
    request.body =
        json.encode({"amount": '${_payingAmount * 100}', "currency": "INR"});
                            ...
                            child: SingleChildScrollView(
                              ...
                              child: Container(
                                ...
                                child: Column(children: [
                                  ...
                                  InkWell(
                                      onTap: () {
                                        // Navigator.push(context, MaterialPageRoute(builder: (context) => ExtendBooking()));
                                        // Extend booking
                                  ...
                                  //         children: [
                                  //           // data.subscription![pos].amountLeft!='0'?Icon(Icons.do_not_disturb_on_total_silence_sharp,color: Colors.redAccent,):  Icon(Icons.do_not_disturb_on_total_silence_sharp,color: Colors.green,),
                                  //           Text('OrderId'),
                                  //           Text('Pickup Date'),
                                  //           Text('Payment '),
                                  //         ],
                                  ...
                                  //                   children: [
                                  //                     // data.subscription![pos].amountLeft!='0'?Icon(Icons.do_not_disturb_on_total_silence_sharp,color: Colors.redAccent,):  Icon(Icons.do_not_disturb_on_total_silence_sharp,color: Colors.green,),
                                  //                     Text(data.subscription![pos].orderId!),
                                  //                     Text(data.subscription![pos].pickupDate!.split(" ")[0]),
                                  //                     GestureDetector(
                                  //                       onTap: (){
                                  //                         order_id=data.subscription![pos].orderId!;
                                  //                         _payingAmount=int.parse(data.subscription![pos]
                                  //                             .amountLeft!);
                                  //                         _pay();
                                  //                       },
                                  //                       child: Container(
                                  ...
                                  //                           alignment: Alignment.center,
                                  //                           decoration: BoxDecoration(
                                  //                               color: data.subscription![pos]
                                  //                                   .amountLeft=='0'?Colors.grey:Colors.green,
                                  //                               borderRadius: BorderRadius.all(Radius.circular(10))
                                  //                           ),
                                  //                           width: 100,
                                  //                           child:data.subscription![pos]
                                  //                               .amountLeft=='0'?Text('Paid') :Text('Rs.${
                                  //                               data.subscription![pos]
                                  //                                   .amountLeft!
                                  //                           }')),
                                  //                     ),
                            ...
                            child: SingleChildScrollView(
                              ...
                              child: Container(
                                ...
                                child: Column(children: [
                                  ...
                                  Visibility(
                                    visible: data.adminStatus!.toLowerCase() ==
                                            'confirmed' ||
                                        data.adminStatus!.toLowerCase() ==
                                            'pending',
                                    child: Row(
                                      children: [
                                        InkWell(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Directionality(
                                                                                  ...
                                                                                  child: GestureDetector(
                                                                                    ...
                                                                                    child: Container(padding: const EdgeInsets.all(10), decoration: BoxDecoration(border: Border.all(), borderRadius: const BorderRadius.all(Radius.circular(10))), child: Text(_selectedEndDate.toString().split(' ')[0], style: TextStyle(fontSize: 14 / scaleFactor))),
                                                                                  )),
                                                                            ),
                                                                          ),
                                                                        ],
  ...
  Future<void> _pay() async {
    ...
    var options = {
      ...
      // 'amount': false ? payInString : '${_payingAmount}00',
      'amount': payInString,
      ...
      'notes': {
        ...
        // 'order_id':
        //     _currentPaying == 'rent' ? order_id : _selectedToExtend!.transId,
